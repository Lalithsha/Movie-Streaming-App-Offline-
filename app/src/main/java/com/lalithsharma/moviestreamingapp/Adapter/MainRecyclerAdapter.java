...
import com.lalithsharma.moviestreamingapp.Model.AllCategory;
...
public class MainRecyclerAdapter extends RecyclerView.Adapter<MainRecyclerAdapter.MainViewHolder> {
    ...
    private void setItemRecycler(RecyclerView recyclerView, List<CategoryItem> categoryItemList){
        ...
        Item_Recycler_Adapter item_recycler_adapter = new Item_Recycler_Adapter(context,categoryItemList);
        recyclerView.setLayoutManager(new LinearLayoutManager(context,RecyclerView.HORIZONTAL,false));
        recyclerView.setAdapter(item_recycler_adapter);
